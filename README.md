...
**Tests and coverage.** `make test` runs the whole suite in one command — 3,338 tests as of
...
over 10,209 statements**, which `coverage report` prints as the combined **94%** the gate reads. The
