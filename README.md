...
**Tests and coverage.** `make test` runs the whole suite in one command — 2,409 tests as of
...
over 7,929 statements**, which `coverage report` prints as the combined **94%** the gate reads. The
