...
**Tests and coverage.** `make test` runs the whole suite in one command — 3,310 tests as of
...
over 10,184 statements**, which `coverage report` prints as the combined **94%** the gate reads. The
