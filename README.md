...
**Tests and coverage.** `make test` runs the whole suite in one command — 2,068 tests as of
...
`coverage report --fail-under=90`. Measured on 2026-09-14: **95% of statements and 87% of branches
over 7,453 statements**, which `coverage report` prints as the combined **94%** the gate reads. The
